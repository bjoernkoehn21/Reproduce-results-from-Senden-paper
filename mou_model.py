...
class MOU(BaseEstimator):
    ...
    def fit_LO(self, Q_obj, i_tau_opt=1, mask_C=None, mask_Sigma=None,
        ...
        # Create a dictionary to store the diagnostics of fit ################################### ADDED by Koehn
        self.d_fit = dict() ################################### ADDED by Koehn
        ...
        # calculation following the instruction in the Senden-paper ################################### ADDED by Koehn
        tau_obj = 1/(np.sum(log_ac[0]-log_ac[1])/self.n_nodes) ################################### ADDED by Koehn
# original calculation commented out by Koehn:
# =============================================================================
